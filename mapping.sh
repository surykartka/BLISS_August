...
samtools sort -o hg_mapping/${NB_R1}_AGACTC_bowtie_sorted.sam hg_mapping/${NB_R1}_AGACTC_bowtie.sam
#fastq_to_fasta -Q33 -i hg_mapping/${NB_R1}_AGACTC_bowtie.sam -o hg_mapping/${NB_R1}_AGACTC_bowtie.fasta
